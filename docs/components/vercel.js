...
const VercelButton = () => {
    ...
    url.searchParams.set("envLink", "https://www.next-forge.com/docs/setup/prerequisites");
    ...
    return (<a href={url.toString()}>
      <image_1.default alt="Deploy with Vercel" height={32} src="https://vercel.com/button" unoptimized width={103}/>
    </a>);
};
exports.VercelButton = VercelButton;
