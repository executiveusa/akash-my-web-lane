...
const NextLogo = (props) => (<svg viewBox=".5 -.2 1023 1024.1" xmlns="http://www.w3.org/2000/svg" {...props}>
    <title>Next.js</title>
...
const TurborepoLogo = (props) => (<svg fill="none" viewBox="0 0 36 36" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" {...props}>
    <title>Turborepo</title>
    <linearGradient gradientUnits="userSpaceOnUse" id="a" x1="19.672" x2="1.96713" y1="2.5292" y2="20.234">
      <stop offset="0" stopColor="#0096ff"/>
      <stop offset="1" stopColor="#ff1e56"/>
    </linearGradient>
    <path d="m17.9856 6.28879c-6.4499 0-11.69727 5.24741-11.69727 11.69721s5.24737 11.6972 11.69727 11.6972c6.4498 0 11.6972-5.2474 11.6972-11.6972s-5.2474-11.69721-11.6972-11.69721zm0 17.75061c-3.3437 0-6.0534-2.7098-6.0534-6.0534s2.7097-6.0534 6.0534-6.0534c3.3436 0 6.0533 2.7098 6.0533 6.0534s-2.7097 6.0534-6.0533 6.0534z" fill="currentColor"/>
    <path clipRule="evenodd" d="m18.9661 4.3674v-4.3674c9.4928.507533 17.0339 8.36667 17.0339 17.9858 0 9.6192-7.5411 17.4762-17.0339 17.9859v-4.3674c7.0749-.5054 12.6774-6.4172 12.6774-13.6185s-5.6025-13.11305-12.6774-13.6184zm-11.29647 22.5493c-1.87548-2.1652-3.08441-4.9229-3.30005-7.9506h-4.36958c.226538 4.2367 1.92122 8.0813 4.57651 11.0415l3.09094-3.0909zm9.33607 9.055v-4.3674c-3.0299-.2157-5.7876-1.4224-7.9528-3.3001l-3.09094 3.091c2.96243 2.6574 6.80704 4.3499 11.04154 4.5765z" fill="url(#a)" fillRule="evenodd"/>
  </svg>);
const Hero = () => (<section className="flex flex-col items-center justify-center gap-6 bg-dashed px-4 py-16 sm:px-16 sm:py-24">
    <a className="inline-flex w-full items-center gap-2 overflow-hidden rounded-full border bg-background py-1 pr-3 pl-1 text-foreground text-sm leading-6 shadow-xs sm:w-fit" href="https://x.com/haydenbleasel/status/1929625673586598148" rel="noreferrer" target="_blank">
