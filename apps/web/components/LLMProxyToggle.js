...
function LLMProxyToggle() {
    ...
    return (<div data-testid="llm-proxy-toggle" style={{
            position: "fixed",
            bottom: 16,
            right: 16,
            zIndex: 9999,
      ...
      {open && (<div style={{
          ...
          <div style={{ fontSize: 12, padding: "6px 0" }}>
            <span style={{
                ...
                height: 8,
                borderRadius: "50%",
                background: health.ok === null ? "#f9e2af" : health.ok ? "#a6e3a1" : "#f38ba8",
                marginRight: 6,
            }}/>
          ...
          {health.error && (<div style={{ fontSize: 10, color: "#f38ba8", marginTop: 6 }}>{health.error}</div>)}
          ...
          <div style={{ marginTop: 10, display: "flex", gap: 8 }}>
            ...
            {lastCheck && (<span style={{ fontSize: 10, color: "#6c7086", alignSelf: "center" }}>{lastCheck}</span>)}
          </div>
...
exports.default = LLMProxyToggle;
