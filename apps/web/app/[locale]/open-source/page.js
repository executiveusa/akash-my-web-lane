...
const OpenSourcePage = async ({ params }) => {
    const { locale } = await params;
    const isHindi = locale === "hi";
    return (<main className="min-h-screen bg-[#0a0a0a] py-20 text-[#f2ece0]">
      <div className="container mx-auto max-w-4xl px-4">
        ...
        <div className="mt-8">
          <link_1.default className="text-[#c9a84c] underline" href="https://github.com/executiveusa/akash-engine-oss">
