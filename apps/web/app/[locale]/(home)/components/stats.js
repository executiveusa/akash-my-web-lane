...
const Stats = () => (<div className="w-full bg-[#0a0a0a] py-20 text-[#f2ece0] lg:py-28">
    <div className="container mx-auto">
      <div className="mx-auto max-w-5xl">
        ...
        <div className="mt-10 grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-4">
          {statsItems.map((item, index) => (<div className="rounded-xl border border-[#f2ece0]/10 bg-[#f2ece0]/5 p-6" key={index}>
