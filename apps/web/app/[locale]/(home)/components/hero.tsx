...
export const Hero = async ({ dictionary, locale }: HeroProps) => {
  ...
  return (
    <section className="relative min-h-screen overflow-hidden bg-[#0a0a0a] py-24 text-[#f2ece0]">
      <div
      ...
      <div className="container relative z-10 mx-auto px-4">
        <div className="mb-8 flex justify-center">
          <a
            className="inline-flex items-center gap-2 rounded-full border border-[#c9a84c]/30 bg-[#c9a84c]/10 px-4 py-2 text-sm font-medium text-[#c9a84c] transition-colors hover:border-[#c9a84c]/60"
            href="/blog"
          >
        ...
        <div className="mx-auto max-w-4xl text-center">
          <h1 className="mb-6 text-5xl leading-[1.05] tracking-tight md:text-7xl">
            ...
            {locale === "hi" ? (
              ...
              "Te lo arreglamos en 25 minutos."
            ) : (
              <>
          ...
          <div className="mb-16 flex flex-col justify-center gap-4 sm:flex-row">
            ...
            <Button
              asChild
              className="h-14 rounded-xl border-[#f2ece0]/20 px-8 text-base font-medium text-[#f2ece0] hover:bg-[#f2ece0]/5"
              size="lg"
              variant="outline"
            >
