...
export function SYNTHIAAdvisorWidget() {
  ...
  return (
    <div className="rounded-xl border bg-card p-4">
      ...
      <div className="mt-3 max-h-64 space-y-2 overflow-y-auto rounded border p-3 text-sm">
        {messages.length === 0 ? (
          <p className="text-muted-foreground">Ask SYNTHIA about offer, product, architecture, or growth strategy.</p>
        ) : (
          messages.map((m, i) => (
            <div key={i}>
      ...
      <div className="mt-3 flex gap-2">
        <input
          ...
          placeholder="What should I do to hit $100K ARR?"
          value={input}
        />
